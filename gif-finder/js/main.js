...
function searchButtonClicked() {
    ...
    // If this one no longer wors, get your own (it's free!)
...
function dataLoaded(e) {
    ...
    // 8 - if there are no results, print a mesasge and return
    ...
    for (let i = 0; i < results.length; i++) {
        ...
        let line = `<div class ='result'><p>Rating: ${result.rating.toUpperCase()}`;
        line += `<span><a target='blank' href='${url}'>View on Giphy</a></span>`;
        line += `</br><img src='${smallURL}' title = '${result.id}' /></div>`;



        // 14 - another way of doing the same thing above
        // Replaves this:
        // var line = "<div class='resulr'>";
        //      line += "<img src='";
        //      line += smallurl;
        //      line += "'title= '";
        //      line += result.id;
